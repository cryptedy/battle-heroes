    ...
    <BaseGrid>
      <BaseCard title="遊び方">
        <div class="how-to-play">
          <section>
            <p>
              BATTLE HEROES は自分の Pixel Heroes NFT
              でバトルを楽しめるシンプルなゲームです。
            </p>
            <p>
              <strong>自分のバトルを作成</strong>
              するか
          ...
          <section>
            ...
            <p>
              また、まれに
              <strong>
                防御後の次のターンの攻撃が必ず強力なクリティカルヒットになる
              </strong>
              効果が発生することがあります。
            </p>
            <p>
              このクリティカルは通常と異なり相手の防御を無効化する確定クリティカルとなったらターンは積極的に攻撃を使っていきましょう。
            </p>
            <p>
              なお、
              <strong>防御に使用回数制限はない</strong>
              ので攻撃回数回復だけでなく確定クリティカル狙いなどさまざまなシーンで積極的に使っていきましょう。
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              の
              <span class="how-to-play-discord">#🎮ゲーム｜games</span>
              チャンネルで新機能の検討や開発進捗などを公開しています。
            </p>
            <p>
              ゲームについてのアイデアや一緒に開発してくれるという方は気軽にチャンネルまでお越しください🚀
            </p>
          </section>
        </div>
      </BaseCard>
